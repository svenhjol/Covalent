...
public class CovalentCrates extends CharmModule {
    ...
    public void register() {
        ...
        for (Coranthemum.Materials material : Coranthemum.Materials.values()) {
            Crates.CRATE_BLOCKS.put(material, new CrateBlock(this, material, Coranthemum.MOD_ID));
        }

        // terrestria
        for (Terrestria.Materials material : Terrestria.Materials.values()) {
            Crates.CRATE_BLOCKS.put(material, new CrateBlock(this, material, Terrestria.MOD_ID));
        }

        // traverse
        for (Traverse.Materials material : Traverse.Materials.values()) {
            Crates.CRATE_BLOCKS.put(material, new CrateBlock(this, material, Traverse.MOD_ID));
        }

        // wild_explorer
        for (WildExplorer.Materials material : WildExplorer.Materials.values()) {
            Crates.CRATE_BLOCKS.put(material, new CrateBlock(this, material, WildExplorer.MOD_ID));
        }
    }
}
