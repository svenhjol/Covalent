...
@Module(mod = Covalent.MOD_ID, category = CharmCategories.DECORATION,
    description = "Adds barrels and crates for Autumnity.")
public class Autumnity extends MesonModule {
    ...
    public void init() {
        super.init();
        IChestMaterialType wood = ExtraChestMaterialTypes.MAPLE;
    ...
    public boolean shouldRunSetup() {
        return Meson.isModuleEnabled("charm:debug") || ForgeHelper.isModLoaded("autumnity");
    }
}
